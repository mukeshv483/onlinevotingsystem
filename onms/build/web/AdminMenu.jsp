...
.navigation:hover .n5 {
     ...
     <table width="100%" height="10" border="0" valign="top" bgcolor="green">
            <tr >
                ...
                <td >
                          ...
                          <li><p:link action="/voter4">Home Page</p:link></li>
        ...
        <li class="n2"><a href="#">Update Information</a></li>
                <li class="n2"><p:link action="/adminvoter">View Voter List</p:link></li>
 ...
 <li> <a class="main" href="#">Candidate</a></li>
   <li class="n2"><p:link action="/admincan">View Candidate List</p:link></li>
...
<td>  
    <ul class="navigation">
        ...
        <li>  <a class="main" href="#">Gallery</a></li>
         <li><p:link action="/voter3">Images</p:link>  </li></ul></td>
  ...
  <li><p:link action="/voterout">Logout</p:link></li>
</ul>         
     </td>>           
       </tr>               
