...
.navigation:hover .n5 {
     ...
     <table width="100%" height="10" border="0" valign="top" bgcolor="green">
            <tr >
                ...
                <td >
                          ...
                          <li><p:link action="/can4">Home Page</p:link></li>
        ...
        <li class="n2"><p:link action="/voter1">Update Information</p:link></li>
 ...
 <li> <a class="main" href="#">Candidate</a></li>
	...
	<li class="n2"><p:link action="/can1">Update Information</p:link></li>
...
<td>  
    <ul class="navigation">
        ...
        <li>  <a class="main" href="#">Gallery</a></li>
         <li><p:link action="/can3">Images</p:link>  </li></ul></td>
...
<td>
  ...
  <li><p:link action="/can2">@Admin</p:link></li>
</ul>
    </td>
        <td>
   
    <ul class="navigation">
        <a class="main" href="#"><%=username%></a>
        <li> <a class="main" href="#">Change Settings</a></li>
  <li><p:link action="/canout">Logout</p:link></li>
</ul>         
